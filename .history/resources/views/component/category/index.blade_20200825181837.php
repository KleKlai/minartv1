...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <a href="javascript:void()" class="link mb-3" data-toggle="modal" data-target="#categoryModal">
                + Category
            </a>
                ...
                <tbody>
                    @foreach($data as $key => $data)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('component.category.destroy', $data) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-header">
                        ...
                        <form method="POST" action="{{ route('component.category.store') }}">
                            @csrf
