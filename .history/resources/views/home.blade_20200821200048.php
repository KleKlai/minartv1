...
<div>
    ...
    <div class="artContainer">
        <img src="images/TBH_RWSX-54.jpg" class="artImage">
    </div>
    <div class="artContainer">
        <img src="images/TBH_RWSX-55.jpg" class="artImage">
    </div>
    <div class="artContainer">
        <img src="images/TBH_RWSX-56.jpg" class="artImage">
    </div>
    <div class="artContainer">
        <img src="images/TBH_RWSX-57.jpg" class="artImage">
    </div>
    <div class="artContainer">
        <img src="images/TBH_RWSX-58.jpg" class="artImage">
    </div> -->
